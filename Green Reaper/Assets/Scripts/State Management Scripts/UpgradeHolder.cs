...
public class UpgradeHolder
{
    ...
    {
        {UpgradeType.SPEED, new float[]{.75f, 1f, 1.25f, 1.5f}},
        ...
        {UpgradeType.PEPPERPROBABILITY, new float[] {0f, 1f, 2f, 3f}},
        {UpgradeType.PUMPKINPROBABILITY, new float[] {0f, 1, 2f, 3f}},
        {UpgradeType.ZUCCINNIPROBABILITY, new float[] {0f, 1f, 2f, 3f}}
    };
