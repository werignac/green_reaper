...
public class WeaponController : MonoBehaviour
{
    ...
    private class PlantHitEntry : IComparable
    {
        ...
        private static readonly Dictionary<PlantType, int> plantTypePriority = new Dictionary<PlantType, int>() {{ PlantType.PUMPKIN, 4 }, { PlantType.ROOTMONSTER, 3 }, { PlantType.ZUCCHINI, 2}, { PlantType.PEPPER, 1 }};
